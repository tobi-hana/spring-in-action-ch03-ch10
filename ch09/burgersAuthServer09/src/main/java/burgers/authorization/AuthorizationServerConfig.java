...
public class AuthorizationServerConfig {
    ...
    public SecurityFilterChain
        authorizationServerSecurityFilterChain(HttpSecurity httpSecurity)
            throws Exception {
    ...
    public RegisteredClientRepository
        registeredClientRepository(PasswordEncoder passwordEncoder) {
...
//    ProviderSettings are not mentioned in the book
//    @Bean
