...
public class DevelopmentConfig {
    ...
    public CommandLineRunner dataLoader(IngredientRepository ingredientRep,
        ...
        return args -> {
            ...
            beefB.setIngredients(Arrays.asList(
                    ingredientRep.findIngredientByName("Toasted Bun"),
            ...
            chickenB.setIngredients(Arrays.asList(
                    ingredientRep.findIngredientByName("Sesame Seed Bun"),
            ...
            fishB.setIngredients(Arrays.asList(
                    ingredientRep.findIngredientByName("Steamed Bun"),
